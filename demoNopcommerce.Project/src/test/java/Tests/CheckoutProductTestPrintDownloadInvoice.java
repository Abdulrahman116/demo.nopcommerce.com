...
public class CheckoutProductTestPrintDownloadInvoice extends TestBase{
    ...
    public static Object[][] userData()
    {
        return new Object[][]
                {
                        {"Abdulrahmn","Alaa","abdo5@gmail.com","123456789"},
                };
    }
            ...
            (String city, String address, String zipCode, String phoneNumber)
    {
        ...
        homeObject = new HomePage(driver);
        checkoutProductObject.addProductToCheckoutPrintAndDownloadInvoice
                (city,address,zipCode,phoneNumber);
