...
public class RegisteredUserCanPrintDownloadProductDeailsTest extends TestBase{
    ...
    String email = "abdo11@gmail.com";
    String city = "Cairo";
    String address = "Esbiko";
    String zipCode = "12345";
    String phoneNumber = "01125165135";
    ...
    public void UserCanRegisterSuccessfuly()
    {
        ...
        registerObject.UserRegisteration("Abdulrahman",
                "Sad",email,"123456789");
        Assert.assertTrue(registerObject.SuccessMessage
    ...
    public void UserCanCompleteOrder() throws InterruptedException {
        ...
        completeOrderObject.GoToOrderDetails();
    }
    @Test(priority = 13)
    public void UserCanPrintDownloadProductDeails() throws InterruptedException {
        orderDetailsObject = new OrderDetailsPage(driver);
        Thread.sleep(500);
        orderDetailsObject.PrintAndDownloadOrderDetails();
        orderDetailsObject.UserCanLogout();
    }
}
